...
# Test image
parser.add_argument('--model_name', default='result/model_3_Harvard.pth', type=str, help='super resolution model name ')
parser.add_argument('--method', default='MCNet', type=str, help='super resolution method name')
